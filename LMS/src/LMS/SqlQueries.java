...
public interface SqlQueries {
	//Add member
	static final String add_member = "INSERT INTO member VALUES ('%d', '%s', '%s', '%s', '0', '0')";
	...
	static final String update_member_type = "UPDATE member SET Type='%s' WHERE MIS=%d";

	//Find member by MIS
	static final String find_member = "SELECT * FROM member WHERE MIS=%d";

	//Add book
	static final String add_book = "INSERT INTO book VALUES ( NULL, '%s', '%s', '%s', '%s', '%s')";

	//Delete book
	static final String del_book = "DELETE FROM book WHERE BID=%d";

	//Update book
	static final String update_book_status = "UPDATE book SET Status='%s' WHERE BID=%d";
	...
	//Issue a book
	static final String issue_book = "INSERT INTO IssuedBooks VALUES(NULL, %d, %d, '%s', '0001-01-01')";
